...
www.philzcoffee.com audit: 0 critical, 0 high, 0 medium, 1 low findings (coverage: 1 pages fetched).
...
- Access limitation: https://philzcoffee.com/: HTTP 200 (captcha / bot verification). These bodies were not used as brand/answerability evidence.
...
- Severity: low
- Evidence: fetched_pages=0; access_kinds=['captcha']; pages=1. Challenge/WAF/HTTP-error bodies are audit limitations, not missing-brand-content.
