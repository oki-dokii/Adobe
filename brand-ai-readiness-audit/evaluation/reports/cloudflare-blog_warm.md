...
- Render budget exhausted: render_max=10, performed=10, skipped_budget=30, protected_requests=2. Protected categories affect fetch/render priority only; the cap is hard.
...
- Severity: medium
- Evidence: visible years=['2026'] schema=['CF295E1604697F9CAD18B5A232E871F6'] on https://blog.cloudflare.com/ja-jp/
- Suggested action: Align dateModified/visible dates or drop fake update stamps.
...
- COMPLETED FINDINGS: F-001, F-030, F-002, F-003, F-004, F-005, F-006, F-007, F-008, F-009, F-010, F-011, F-012, F-013, F-014
