...
## 15. Severity
Critical: core identity/price/legal JS-only. High: interaction-gated central claim. Medium-High: **sole** carrier of a material fact is an image with missing/non-specific alt (N-008; WebAIM ~53% missing-alt prevalence means **materiality gate is mandatory** — do not spam every missing alt). Low: missing OG. No finding: decorative `alt=""`.
